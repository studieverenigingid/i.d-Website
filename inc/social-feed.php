<?php
		...
		function latestVimeoPosts($options) {
			...
			foreach($videos['body']['data'] as $video) {
				...
				echo "<a class='social__link' href=".$link." target='_blank' ><div class='social__container--vimeo' style='background-image:url(".$largestPicture.");' >
					<div class='social__title social__title--vimeo'><i class='fa fa-vimeo'></i> Vimeo</div></div></a>";
			}
		}
		...
		function latestInstaPosts($options) {
			...
			foreach ($posts['data'] as $post) {
				...
				echo "<a class='social__link' href=".$link." target='_blank' ><div class='social__container--insta' style='background-image:url(".$image_url.");' >
				<div class='social__title social__title--insta'><i class='fa fa-instagram'></i> Instagram</div></div></a>";
			}
		}
