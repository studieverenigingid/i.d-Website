...
acf_add_local_field_group(array (
	...
	'fields' => array (
		array (
			...
			'type' => 'color_picker',
			'value' => NULL,
			'instructions' => 'Pick the colour for the background of the header of the page. If this is an event and you don’t select one, it will be automagically deduced from the post thumbnail by the ID Website algorithm (SINGULARITY IS IMMINENT).',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
